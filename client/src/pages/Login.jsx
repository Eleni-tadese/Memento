  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 left-1/4 h-72 w-72 rounded-full bg-[#5C1A28]/8 dark:bg-[#5A2532]/12 blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 h-56 w-56 rounded-full bg-[#7AAEC8]/10 dark:bg-[#5A2532]/25 blur-2xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/50 dark:border-[#CBA24A]/10 bg-white/70 dark:bg-[#5A2532]/60 backdrop-blur-md shadow-2xl p-8">
          ...
          <div className="mt-7 text-center text-sm text-[#1A2B48]/50 dark:text-[#CBA24A]/70">
            ...
            <Link to="/signup" className="font-medium text-[#5C1A28] dark:text-[#BF8F8F] hover:underline transition-colors">
              Sign up
            </Link>
          </div>
        </div>
